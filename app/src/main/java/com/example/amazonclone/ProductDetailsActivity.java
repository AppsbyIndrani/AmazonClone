...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        related_prod_list.setLayoutManager(new LinearLayoutManager(ProductDetailsActivity.this, LinearLayoutManager.HORIZONTAL,true));
...
//            Toast.makeText(this, "In correct block", Toast.LENGTH_SHORT).show();
    ...
    private void addingToCartList()
    {
        ...
        cartListRef.child("User View").child(Objects.requireNonNull(auth.getCurrentUser()).getUid()).child("Products")
